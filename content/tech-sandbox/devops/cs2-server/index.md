---
title: "AWS CDK Counter-Strike 2 Server"
date: 2026-01-10
summary: "A server to host Counter-Strike 2 games using AWS CDK"
tags:
  - Backend
  - API
  - Reactor
...
links:
  - type: github
    url: https://github.com/leonardosalles/devops-sandbox/tree/main/pocs/aws-cdk-cs2-server
    label: Code
featured: false
role: "Lead Developer"
highlights:
  - "Uses AWS CDK to deploy a Counter-Strike 2 server"
  - "Uses AWS EC2 to host the server"
  - "Uses AWS S3 to store server files"
---
